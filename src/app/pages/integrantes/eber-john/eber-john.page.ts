...
@Component({
  selector: 'app-eber-john',
  templateUrl: './eber-john.page.html',
  styleUrls: ['./eber-john.page.scss'],
})
export class EberJohnPage implements OnInit {
  ...
  constructor(private navCtrl: NavController, private titleService: Title) {
    ...
    this.titleService.setTitle('Eber John de Oliveira Rangel')
  }
